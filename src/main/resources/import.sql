...
INSERT INTO `onlinestore`.`user` (`id`, `email`, `first_name`, `last_name`, `password`) VALUES ('9001', 'a@a', 'Manolo', 'Benitez', '$2a$10$2DHv24iI/uwmLBoR1ObyKutZ.q9E/fGuJa2OZBOr6JFw/dA3KVZvm');
INSERT INTO `onlinestore`.`user` (`id`, `email`, `first_name`, `last_name`, `password`) VALUES ('9002', 'b@b', 'Manolo', 'Benitez', '$2a$10$2DHv24iI/uwmLBoR1ObyKutZ.q9E/fGuJa2OZBOr6JFw/dA3KVZvm');
